...
class Test:
    ...
    def test_Str(self) -> None:
        assert dyn_typing.Str().isinstance("1")
        assert not dyn_typing.Str().isinstance(1)
...
@dyn_typing.dyn_check_3(
    input=(dynInt, dynInt, dynInt), output=dyn_typing.Class(type(None))
)
...
@dyn_typing.dyn_check_4(
    input=(dynInt, dynInt, dynInt, dynInt), output=dyn_typing.Class(type(None))
)
...
@dyn_typing.dyn_check_5(
    input=(dynInt, dynInt, dynInt, dynInt, dynInt), output=dyn_typing.Class(type(None))
)
...
@dyn_typing.dyn_check_6(
    input=(dynInt, dynInt, dynInt, dynInt, dynInt, dynInt),
...
@tuplize.tuplize_7
@dyn_typing.dyn_check_7(
    input=(dynInt, dynInt, dynInt, dynInt, dynInt, dynInt, dynInt),
    output=dyn_typing.Class(type(None)),
)
...
@dyn_typing.dyn_check_8(
    input=(dynInt, dynInt, dynInt, dynInt, dynInt, dynInt, dynInt, dynInt),
    output=dyn_typing.Class(type(None)),
)
...
@tuplize.tuplize_9
@dyn_typing.dyn_check_9(
    input=(dynInt, dynInt, dynInt, dynInt, dynInt, dynInt, dynInt, dynInt, dynInt),
    output=dyn_typing.Class(type(None)),
)

...
def _tuplize_unsafe(
    f: _Callable[..., _return_t]
) -> _Callable[[_Tuple[_Any, ...]], _return_t]:
    @_wraps(f)
...
def tuplize_2(
    f: _Callable[[_T1, _T2], _return_t]
) -> _Callable[[_Tuple[_T1, _T2]], _return_t]:
    return _tuplize_unsafe(f)


def tuplize_3(
    f: _Callable[[_T1, _T2, _T3], _return_t]
) -> _Callable[[_Tuple[_T1, _T2, _T3]], _return_t]:
    return _tuplize_unsafe(f)
